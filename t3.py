...
class App:
    def __init__(self, window, window_title, image_path="C:/Users/jeffr/Documents/Standard Documents/Programming/Projects/VS Code DEV/SignRecorder/test_files/test_images/Blue.png"):
        self.window = window
